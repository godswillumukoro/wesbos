...
![cors blocked error in console](./1208.png)
...
![live server extension for vs code](./1209.png)
...
![open with live server in context menu](./1210.png)

![live server started the application at url `127.0.0.1:5550` which is equivalent to localhost](./1211.png)
...
![is working log in console](./1215.png)
...
![uncaught reference error, last is not defined](./1216.png)
...
![hi wes bos, its working log in console](./1217.png)
...
The variable `last` would not be available in the console if you were to try, because it is not globally scoped, and it is not available in the `scripts` module. The `last` variable is simply scoped to the `utils` file and can only be used within that file.
...
![console log last in code and console](./1218.png)
...
![last and middle variable logs in console](./1219.png)
...
![imported wes module as console log](./1220.png)
...
![named and default modules imports log in console](./1221.png)
...
![returnHi function as console log](./1222.png)
...
![mdn import module documentation](./1223.png)
...
![utils not found error in console](./1225.png)
...
![whole module logged in console](./1227.png)
...
![module having default dog eat and food properties](./1228.png)
...
![mdn documentation about exporting module](./1229.png)
...
![clicking the load currencies button](./1230.png)
...
![network tab requests to load the data](./1231.png)
...
![all filter in the network tab](./1232.png)

![loaded script.js in network tab](./1233.png)

That request was only made after we clicked the button. Now we have the module logged in the console.

![loaded module log in console tab](./1234.png)
...
![currencies in console](./1235.png)
...
![loadCurrency module in coonsole](./1236.png)
...
![destructuring an import result in console](./1237.png)
